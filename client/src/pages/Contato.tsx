        ...
        <div className="container">
          <div className="text-center mb-16">
            <h2 className="font-display text-3xl md:text-4xl font-bold mb-4">
              Formas de <span className="text-gradient">Contato</span>
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Escolha a forma mais conveniente para você se comunicar conosco
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto mb-12">
            ...
            <Card className="border-none shadow-lg hover:shadow-xl transition-all">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground mb-6">
                  Envie uma mensagem e receba resposta rápida
                </p>
                <a
                  href="https://wa.me/5579996402118?text=Olá! Gostaria de falar com o Instituto Fonte das Águas."
                  target="_blank"
            ...
            <Card className="border-none shadow-lg hover:shadow-xl transition-all">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground mb-6">
                  Ligue durante o horário comercial
                </p>
                <a
                  href="tel:+5579991439647"
            ...
            <Card className="border-none shadow-lg hover:shadow-xl transition-all">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Rua Adezinho da Costa Pinto, 149<br />
                  Bairro Industrial<br />
                  Aracaju/SE - CEP: 49065-010
                </p>
                <a
                  href="https://maps.google.com/?q=Rua+Adezinho+da+Costa+Pinto,+149,+Aracaju,+SE"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      required
                      className="w-full px-4 py-2 rounded-lg border border-input bg-background mt-2"
                    >
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="font-display text-3xl font-bold mb-4">
              Acompanhe Nossas <span className="text-gradient">Redes Sociais</span>
            </h2>
            <p className="text-lg text-muted-foreground mb-8">
              Fique por dentro de todas as ações, notícias e momentos do Instituto
            </p>
            <a
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center text-white">
            ...
            <p className="text-xl mb-8 leading-relaxed opacity-90">
              Seja como voluntário, doador ou parceiro, sua contribuição transforma vidas 
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="https://wa.me/5579996402118?text=Olá! Gostaria de saber mais sobre como posso ajudar o Instituto."
                target="_blank"
                rel="noopener noreferrer"
              >
